...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5707680,
    DYNAMIC_BASE = 5707680,
    DYNAMICTOP_PTR = 464768;
...
function nullFunc_viifff(x) { abortFnPtrError(x, 'viifff'); }
