    ...
    */
    ...
    if (data.updateMaterial || data.updateGeometry ) {
      this.time_material = window.tic();
        ...
        this.geometry.setAttribute( 'opacity', new THREE.BufferAttribute( vertexOpacities, 1 ) );
        this.geometry.setAttribute( 'height01', new THREE.BufferAttribute( vertexHeights, 1 ) );
